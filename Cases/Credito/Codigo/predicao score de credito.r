...
#a ideia é que conforme haver o incremento de dados, com novos clientes solicitando credito, e conforme também temos todas as outras variaveis preenchidas do dataset
